...
export type ErrorType = 'frontend' | 'api' | 'auth' | 'database' | 'user_action' | 'system';
...
export interface LoginHistory {
  ...
  inferred_logout_time?: string | null;
  logout_type?: 'explicit' | 'next_login' | 'timeout' | 'active';
...
export interface Question {
  ...
  serial_number?: string; // Persistent serial number (e.g., '001', '002', '003') - auto-generated by database
}
...
export interface QuestionPaperQuestion {
  ...
  original_serial_number?: string | null; // Original serial number from questions table - auto-generated by database
  created_at: string;
}
